...
6. **Run the `examine_image.py`**
  ...
  "This code extracts data from images starting with 1.jpg up to 129.jpg in the data folder. If you modify the starting path (e.g., 2.jpg instead of 1.jpg), it will extract data for the images from that new starting point, resulting in different extraction outputs."
